...
public class SQLInjectionTest extends AbstractValidatorTest {
  ...
  public void registeredChecks() {
    ...
    Assert.assertEquals(9501, ((((PLSQLCopGuideline[])Conversions.unwrapArray(guidelines.values(), PLSQLCopGuideline.class))[0]).getId()).intValue());
  }
  ...
  public void issue1_ut_utils_wrapper() {
    ...
    _builder.newLine();
    _builder.append("  ");
    _builder.append("function get_missing_objects(a_object_owner varchar2, a_object_type varchar2) return ut_annotation_objs_cache_info is");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("l_data := ut_annotation_cache_manager.get_annotations_objects_info(a_object_owner, a_object_type);");
    _builder.newLine();
    _builder.append("    ");
  ...
  public void issue14_duplicate_warnings_are_ok_for_multiple_plsql_statements() {
    ...
    Assert.assertEquals(7, ((((Issue[])Conversions.unwrapArray(issues, Issue.class))[0]).getLineNumber()).intValue());
    Assert.assertEquals(7, ((((Issue[])Conversions.unwrapArray(issues, Issue.class))[1]).getLineNumber()).intValue());
  }
