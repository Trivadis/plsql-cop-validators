...
public class OverrideTrivadisGuidelines extends TrivadisGuidelines3 implements PLSQLCopValidator {
    ...
    public boolean isLoggerCall(EObject obj) {
        if (obj == null) {
            ...
            BinaryCompoundExpressionLevel7 func = EcoreUtil2.getContainerOfType(obj,
    ...
    public void checkGuideline5(PLSQLFile file) {
        ...
        List<SimpleExpressionNumberValue> numbers = EcoreUtil2.getAllContentsOfType(file,
                SimpleExpressionNumberValue.class);
        ...
        List<SimpleExpressionStringValue> strings = EcoreUtil2.getAllContentsOfType(file,
