...
public class Hint extends PLSQLValidator implements PLSQLCopValidator {
  ...
  // @formatter:off
  private final HashSet<String> ALL_HINTS = new HashSet<String>(Arrays.<String>asList(
      "ADAPTIVE_PLAN",
      "ALL_ROWS",
      "AND_EQUAL",
      "ANSI_REARCH",
    ...
    private void warning(int id, String msg, HintOrComment h, int offset, int length) {
        ...
        sb.append(getGuidelineId(Integer.valueOf(id)));
        sb.append(": ");
        sb.append(getGuidelines().get(Integer.valueOf(id)).getMsg());
        sb.append(" ");
        sb.append(msg);
        this.acceptWarning(sb.toString(), h, node.getOffset() + 3 + offset, length,
                this.getGuidelineId(Integer.valueOf(id)), new String[] { h.getText() });
    }
    ...
    private boolean isFirstHint(HintOrComment h) {
        ...
        HintOrComment _findFirst = IterableExtensions.<HintOrComment>findFirst(this.getAllHints(h.eContainer()),
                _function);
    ...
    private boolean looksLikeHint(final HintOrComment h) {
        if (h.getText().length() > 2 && h.getText().substring(2, 3).equals("+")) {
            return true;
        }
        return false;
    }
    ...
    private ArrayList<Pair<String, String>> _getTableReference(final QueryBlock stmt) {
        ...
        final List<TableReference> tabrefs = EcoreUtil2.<TableReference>getAllContentsOfType(stmt,
    ...
    private ArrayList<Pair<String, String>> _getTableReference(final InsertStatement stmt) {
        final ArrayList<Pair<String, String>> result = new ArrayList<Pair<String, String>>();
        final List<InsertIntoClause> tabrefs = EcoreUtil2.<InsertIntoClause>getAllContentsOfType(stmt,
    ...
    private void checkTabspec(final HintOrComment h, final String hint, final String tabspec, final int tabspecOffset,
            final List<Pair<String, String>> tabrefs) {
    ...
    private void checkLeadingHintSyntaxStyle(final HintOrComment h) {
        final List<String> hints = Arrays.<String>asList("CACHE", "CLUSTER", "DRIVING_SITE", "FACT", "FULL", "HASH",
                "INMEMORY", "INMEMORY_PRUNING", "LEADING", "NOCACHE", "NO_FACT", "NO_INMEMORY", "NO_INMEMORY_PRUNING",
                "NOPARALLEL", "NO_PARALLEL", "NO_PQ_SKEW", "NO_USE_BAND", "NO_USE_CUBE", "NO_USE_HASH", "NO_USE_MERGE",
                "NO_USE_NL", "PQ_DISTRIBUTE", "PQ_SKEW", "PX_JOIN_FILTER", "USE_BAND", "USE_CUBE", "USE_HASH",
                "USE_MERGE", "USE_NL");
        StringConcatenation _builder = new StringConcatenation();
        _builder.append("(?i)(\\s|\\+)(");
        {
    ...
    private void checkIndexSyntaxStyle(final HintOrComment h) {
        final List<String> hints = Arrays.<String>asList("INDEX", "INDEX_ASC", "INDEX_COMBINE", "INDEX_DESC",
                "INDEX_FFS", "INDEX_JOIN", "INDEX_SS", "INDEX_SS_ASC", "INDEX_SS_DESC", "NO_INDEX", "NO_INDEX_FFS",
                "NO_INDEX_SS", "NOPARALLEL_INDEX", "NO_PARALLEL_INDEX", "NO_ZONEMAP", "PARALLEL_INDEX",
                "USE_NL_WITH_INDEX");
        StringConcatenation _builder = new StringConcatenation();
        _builder.append("(?i)(\\s|\\+)(");
        {
