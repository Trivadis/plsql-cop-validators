...
class Hint extends PLSQLJavaValidator implements PLSQLCopValidator {
	...
	// added PARALLEL, NOPARALLEL_INDEX, NO_USE_BAND, USE_BAND
	val ALL_HINTS = new HashSet<String>(
		Arrays.asList("ADAPTIVE_PLAN", "ALL_ROWS", "AND_EQUAL", "ANSI_REARCH", "ANSWER_QUERY_USING_STATS", "ANTIJOIN",
			...
			"NOAPPEND", "NOCACHE", "NOPARALLEL", "NOPARALLEL_INDEX", "NO_ACCESS", "NO_ADAPTIVE_PLAN", "NO_ANSI_REARCH",
			...
			"NO_TABLE_LOOKUP_BY_NL", "NO_TRANSFORM_DISTINCT_AGG", "NO_UNNEST", "NO_USE_BAND", "NO_USE_CUBE",
			...
			"OUTER_JOIN_TO_ANTI", "OUTER_JOIN_TO_INNER", "OUTLINE", "OUTLINE_LEAF", "OVERFLOW_NOMOVE", "PARALLEL",
			"PARALLEL_INDEX", "PARTIAL_JOIN", "PARTIAL_ROLLUP_PUSHDOWN", "PDB_LOCAL_ONLY", "PIV_GB", "PIV_SSF",
			"PLACE_DISTINCT", "PLACE_GROUP_BY", "PQ_CONCURRENT_UNION", "PQ_DISTRIBUTE", "PQ_DISTRIBUTE_WINDOW",
			"PQ_EXPAND_TABLE", "PQ_FILTER", "PQ_MAP", "PQ_NOMAP", "PQ_REPLICATE", "PQ_SKEW", "PRECOMPUTE_SUBQUERY",
			"PRESERVE_OID", "PULL_PRED", "PUSH_HAVING_TO_GBY", "PUSH_PRED", "PUSH_SUBQ", "PX_FAULT_TOLERANCE",
			"PX_JOIN_FILTER", "QB_NAME", "QUARANTINE", "QUEUE_CURR", "QUEUE_ROWP", "RBO_OUTLINE", "REF_CASCADE_CURSOR",
			"REMOTE_MAPPED", "REORDER_WIF", "RESERVOIR_SAMPLING", "RESTORE_AS_INTERVALS", "RESTRICT_ALL_REF_CONS",
			"RESULT_CACHE", "RETRY_ON_ROW_CHANGE", "REWRITE", "REWRITE_OR_ERROR", "ROWID", "RULE", "SAVE_AS_INTERVALS",
			"SCN_ASCENDING", "SEMIJOIN", "SEMIJOIN_DRIVER", "SEMI_TO_INNER", "SET_TO_JOIN", "SHARED",
			"SKIP_EXT_OPTIMIZER", "SKIP_PROXY", "SKIP_UNQ_UNUSABLE_IDX", "SQLLDR", "SQL_SCOPE", "STAR",
			"STAR_TRANSFORMATION", "STATEMENT_QUEUING", "STREAMS", "SUBQUERY_PRUNING", "SUPPRESS_LOAD",
			"SWAP_JOIN_INPUTS", "SYSTEM_STATS", "SYS_DL_CURSOR", "SYS_PARALLEL_TXN", "SYS_RID_ORDER",
			"TABLE_LOOKUP_BY_NL", "TABLE_STATS", "TIV_GB", "TIV_SSF", "TRACING", "TRANSFORM_DISTINCT_AGG", "UNNEST",
			"USE_ANTI", "USE_BAND", "USE_CONCAT", "USE_CUBE", "USE_DAGG_UNION_ALL_GSETS", "USE_HASH",
			"USE_HASH_AGGREGATION", "USE_HASH_GBY_FOR_DAGGPSHD", "USE_HASH_GBY_FOR_PUSHDOWN", "USE_HIDDEN_PARTITIONS",
